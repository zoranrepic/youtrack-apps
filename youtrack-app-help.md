...
Manage, configure, and debug YouTrack apps from an external development environment.
...
App lifecycle:
  ...
  download <app> [--output DIR] [--overwrite]
    ...
    Args:
      <app> is an app ID, package name, or title.
  ...
  validate <directory> [--manifest FILE] [--schema FILE]
    ...
    Args:
      ...
      --manifest FILE overrides the default manifest file.
...
App details and configuration:
  ...
  settings <app> [--project <short-name>] [--json]
    ...
    Args:
      <app> is resolved by title or package name.
  ...
  logs <app> [--top N] [--json]
    ...
    Args:
      <app> is an app ID, package name, or title.
      --top N limits how many entries are requested.
...
Instance exploration:
  ...
  project-info <project> [--skip N] [--limit N] [--yaml]
    Does: Shows identifying details for one project in the YouTrack instance.
    Args:
      <project> is an exact project ID, short name, or name.
  project-fields <project> [--skip N] [--limit N] [--yaml]
  ...
  group-members <group> [--skip N] [--limit N] [--yaml]
    Does: Shows direct members of one user group or project team in the YouTrack instance.
    Args:
      <group> is an exact user group or project team ID or name.
  ...
  user-info <user> [--skip N] [--limit N] [--yaml]
